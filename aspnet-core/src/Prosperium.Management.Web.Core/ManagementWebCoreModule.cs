...
using Prosperium.Management.Authentication.JwtBearer;
...
namespace Prosperium.Management
{
    ...
    public class ManagementWebCoreModule : AbpModule
    {
        ...
        public ManagementWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(ManagementApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ManagementWebCoreModule).GetAssembly());
        }
