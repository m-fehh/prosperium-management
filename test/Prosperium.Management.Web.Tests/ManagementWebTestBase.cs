...
using Prosperium.Management.Models.TokenAuth;
...
{
    public abstract class ManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ManagementDbContext, Task<T>> func)
        {
            T result;
